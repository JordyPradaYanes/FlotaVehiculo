                        ...
                        <div class="card shadow-sm">
                            <div class="card-header bg-primary text-white">
                                <h3 class="card-title mb-0">
                                    <i class="fas fa-edit"></i> Actualizar Información del Vehículo
                                </h3>
                            </div>
                                        ...
                                        <div class="col-md-6 mb-3">
                                            <div class="form-group">
                                                ...
                                                <input type="text"
                                                    ...
                                                    name="placa" id="placa" placeholder="Ej: ABC-123"
                                                    autocomplete="off" value="{{ old('placa', $vehiculo->placa) }}"
                                        ...
                                        <div class="col-md-6 mb-3">
                                            <div class="form-group">
                                                ...
                                                <input type="text"
                                                    ...
                                                    name="modelo" id="modelo" placeholder="Ej: Corolla, Civic, Spark"
                                                    autocomplete="off" value="{{ old('modelo', $vehiculo->modelo) }}"
                                                    required>
                                                @error('modelo')
                                                    <div class="invalid-feedback">{{ $message }}</div>
                                                @enderror
                                    ...
                                    <div class="row">
                                        <div class="col-md-4 mb-3">
                                            <div class="form-group">
                                                ...
                                                <input type="number"
                                                    class="form-control @error('año') is-invalid @enderror" name="año"
                                                    id="año" placeholder="Ej: 2023" autocomplete="off"
                                        ...
                                        <div class="col-md-4 mb-3">
                                            <div class="form-group">
                                                ...
                                                <input type="text"
                                                    ...
                                                    name="color" id="color" placeholder="Ej: Rojo, Azul, Negro"
                                        ...
                                        <div class="col-md-12 mb-3">
                                            <div class="form-group">
                                                ...
                                                <small class="form-text text-muted">Formatos permitidos: JPG, JPEG, PNG,
                                                    GIF. Tamaño máximo: 10MB. Dejar vacío para mantener la imagen
                                                    actual.</small>
                                                @error('imagen')
