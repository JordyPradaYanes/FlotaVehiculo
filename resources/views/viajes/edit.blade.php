        ...
        <section class="content-header">
            <div class="container-fluid">
                <div class="d-flex justify-content-between align-items-center mb-3">
                    <h1 class="m-0"><i class="fas fa-edit mr-2"></i>Editar Viaje</h1>
                        ...
                        <div class="card shadow-sm border-0">
                            <div class="card-header bg-primary text-white">
                                <h3 class="card-title mb-0">
                                    <i class="fas fa-edit mr-2"></i>Actualizar Viaje
                                </h3>
                            </div>
                            ...
                            <form method="POST" action="{{ route('viajes.update', $viaje->id) }}">
                                ...
                                <div class="card-body">
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <input type="number"
                                                    ...
                                                    name="recorrido" id="recorrido"
                                                    value="{{ old('recorrido', $viaje->recorrido) }}" placeholder="Ej: 100"
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <input type="number"
                                                    ...
                                                    value="{{ old('tiempo_estimado', $viaje->tiempo_estimado) }}"
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <input type="number"
                                                    ...
                                                    value="{{ old('costo_total', $viaje->costo_total) }}"
                                    ...
                                    {{-- Campo oculto --}}
                                    <input type="hidden" name="estado" value="{{ $viaje->estado }}">
