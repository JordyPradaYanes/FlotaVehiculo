                            ...
                            <form action="{{ route('empresas.update', $empresa->id) }}" method="POST" id="empresaForm">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text"
                                                    ...
                                                    name="nit" value="{{ old('nit', $empresa->nit) }}"
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <textarea class="form-control @error('direccion') is-invalid @enderror" id="direccion" name="direccion" rows="3"
                                                    placeholder="Ingrese la dirección completa" required>{{ old('direccion', $empresa->direccion) }}</textarea>
                                                @error('direccion')
                                                    <span class="invalid-feedback">{{ $message }}</span>
                                                @enderror
                                            </div>
                                        ...
                                        <input type="hidden" name="estado" value="{{ $empresa->estado ? 1 : 0 }}">
                                        <input type="hidden" name="registrado_por"
                                            value="{{ $empresa->registrado_por }}">
