        ...
        <section class="content-header">
            <div class="container-fluid">
                <div class="d-flex justify-content-between align-items-center mb-3">
                    <h1 class="m-0"><i class="fas fa-edit mr-2"></i>Editar Tipo de Vehículo</h1>
                        ...
                        <div class="card shadow-sm border-0">
                            <div class="card-header bg-primary text-white">
                                <h3 class="card-title mb-0">
                                    <i class="fas fa-edit mr-2"></i>Actualizar Tipo de Vehículo
                                </h3>
                            </div>
                            ...
                            <form method="POST" action="{{ route('tipo_vehiculos.update', $tipo_vehiculo->id) }}">
                                ...
                                <div class="card-body">
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <input type="number"
                                                    ...
                                                    placeholder="Ej: 500" min="0" step="0.01" required>
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <input type="number"
                                                    ...
                                                    placeholder="Ej: 50" min="0" step="0.01" required>
                                    ...
                                    {{-- Campo oculto --}}
                                    <input type="hidden" name="estado" value="{{ $tipo_vehiculo->estado }}">
                                    <input type="hidden" name="registrado_por"
                                        value="{{ $tipo_vehiculo->registrado_por }}">
