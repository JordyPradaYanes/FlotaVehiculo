                                        ...
                                        <tbody>
                                            @foreach ($tipo_vehiculos as $tipo)
                                                <tr>
                                                    ...
                                                    <td>
                                                        <span
                                                            class="text-secondary">{{ Str::limit($tipo->descripcion, 40) }}</span>
                                                    </td>
                                                    ...
                                                    <td class="text-center">
                                                        ...
                                                        @endif
                                                        <input data-type="tipo_vehiculos" data-id="{{ $tipo->id }}"
                                                    ...
                                                    <td class="text-center">
                                                        <div class="btn-group" role="group">
                                                            ...
                                                            <form class="d-inline delete-form"
                                                                action="{{ route('tipo_vehiculos.destroy', $tipo->id) }}"
                                                                method="POST">
                                                                @csrf
                                                                @method('DELETE')
                            ...
                            <div class="card-footer bg-white border-top">
                                <div class="d-flex justify-content-between align-items-center">
                                    <div class="text-muted">
                                        Mostrando {{ $tipo_vehiculos->firstItem() ?? 0 }} a
                                        {{ $tipo_vehiculos->lastItem() ?? 0 }}
