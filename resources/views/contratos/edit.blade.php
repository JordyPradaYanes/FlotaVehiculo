        ...
        <section class="content-header">
            <div class="container-fluid">
                <div class="d-flex justify-content-between align-items-center mb-3">
                    <h1 class="m-0"><i class="fas fa-edit mr-2"></i>Editar Contrato</h1>
                        ...
                        <div class="card shadow-sm border-0">
                            <div class="card-header bg-primary text-white">
                                <h3 class="card-title mb-0">
                                    <i class="fas fa-edit mr-2"></i>Actualizar Contrato
                                </h3>
                            </div>
                            ...
                            <form method="POST" action="{{ route('contratos.update', $contrato->id) }}">
                                ...
                                <div class="card-body">
                                    ...
                                    {{-- Campos ocultos --}}
                                    <input type="hidden" name="estado" value="{{ $contrato->estado }}">
