        ...
        <section class="content-header">
            <div class="container-fluid">
                <div class="d-flex justify-content-between align-items-center mb-3">
                    <h1 class="m-0"><i class="fas fa-edit mr-2"></i>Editar Licencia</h1>
                        ...
                        <div class="card shadow-sm border-0">
                            <div class="card-header bg-primary text-white">
                                <h3 class="card-title mb-0">
                                    <i class="fas fa-edit mr-2"></i>Actualizar Licencia
                                </h3>
                            </div>
                            ...
                            <form method="POST" action="{{ route('licencias.update', $licencia->id) }}">
                                ...
                                <div class="card-body">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text"
                                                    ...
                                                    value="{{ old('numero_licencia', $licencia->numero_licencia) }}"
                                                    placeholder="Ej: LIC-1234-5678" required>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="date"
                                                    ...
                                                    value="{{ old('fecha_vencimiento', $licencia->fecha_vencimiento) }}"
                                                    required>
                                    ...
                                    {{-- Campos ocultos --}}
                                    <input type="hidden" name="estado" value="{{ $licencia->estado }}">
