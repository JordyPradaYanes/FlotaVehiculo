                                    ...
                                    <div class="col-lg-12 col-sm-12 col-md-12 col-xs-12">
                                        <div class="form-group label-floating">
                                            ...
                                            <input type="text" class="form-control" name="numero_licencia"
                                                placeholder="Por ejemplo, 123456789" autocomplete="off"
                                    ...
                                    <div class="col-lg-12 col-sm-12 col-md-12 col-xs-12">
                                        <div class="form-group label-floating">
                                            <label class="control-label">Tipo de Licencia <strong
                                                    style="color:red;">(*)</strong></label>
                                            <input type="text" name="tipo_licencia" placeholder="Por ejemplo, A"
                                                class="form-control" autocomplete="off"
                                                value="{{ old('tipo_licencia') }}" required>
                                        </div>
                                    </div>
                                </div>
                                 <div class="row">
