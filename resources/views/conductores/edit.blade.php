        ...
        <section class="content-header">
            <div class="container-fluid">
                <div class="d-flex justify-content-between align-items-center mb-3">
                    <h1 class="m-0"><i class="fas fa-edit mr-2"></i>Editar Conductor</h1>
                        ...
                        <div class="card shadow-sm border-0">
                            <div class="card-header bg-primary text-white">
                                <h3 class="card-title mb-0">
                                    <i class="fas fa-edit mr-2"></i>Actualizar Información del Conductor
                                </h3>
                            </div>
                            ...
                            <form method="POST" action="{{ route('conductores.update', $conductor->id) }}">
                                ...
                                <div class="card-body">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text"
                                                    ...
                                                    value="{{ old('nombre', $conductor->nombre) }}" placeholder="Ej: Juan"
                                                    required>
                                                @error('nombre')
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="date"
                                                    ...
                                                    value="{{ old('fecha_nacimiento', $conductor->fecha_nacimiento) }}"
                                                    required>
                                    ...
                                    {{-- Campos ocultos --}}
                                    <input type="hidden" name="estado" value="{{ $conductor->estado ? 1 : 0 }}">
