        ...
        <section class="content-header">
            <div class="container-fluid">
                <div class="d-flex justify-content-between align-items-center mb-3">
                    <h1 class="m-0"><i class="fas fa-user-plus mr-2"></i>Nuevo Conductor</h1>
                        ...
                        <div class="card shadow-sm border-0">
                            <div class="card-header bg-primary text-white">
                                <h3 class="card-title mb-0">
                                    <i class="fas fa-plus-circle mr-2"></i>Registrar Nuevo Conductor
                                </h3>
                            </div>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text"
                                                    ...
                                                    name="documento" id="documento" value="{{ old('documento') }}"
                                ...
                                <div class="card-footer bg-light">
                                    <div class="d-flex justify-content-between">
                                        ...
                                        <button type="submit" class="btn btn-primary">
                                            <i class="fas fa-save mr-1"></i> Guardar Conductor
                                        </button>
                                    </div>
                                </div>
                            </form>
