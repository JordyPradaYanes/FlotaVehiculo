// vehiculos - funcionalidad de busqueda, confirmacion y validacion
    ...
    searchInput.addEventListener("keyup", function (e) {
        ...
        rows.forEach(function (row) {
            try {
                ...
                const marca = cells[1].textContent.toLowerCase();
                const tipo = cells[2].textContent.toLowerCase();
                const placa = cells[3].textContent.toLowerCase();
                const modelo = cells[4].textContent.toLowerCase();
                const año = cells[5].textContent.toLowerCase();
                const color = cells[6].textContent.toLowerCase();
                const kilometraje = cells[7].textContent.toLowerCase();
                ...
                const matches =
                    ...
                    año.includes(searchTerm) ||
                    color.includes(searchTerm) ||
                    kilometraje.includes(searchTerm) ||
...
window.addEventListener("error", function (event) {
    if (event.filename.includes("vehiculos.js")) {
        console.error(
            "Error en vehiculos.js:",
            event.message,
            "en",
            event.filename,
            "línea",
