// Marcas - Funcionalidad de búsqueda y eliminación
document.addEventListener('DOMContentLoaded', function() {
    console.log('Marcas.js cargado correctamente');
    ...
    searchInput.addEventListener('keyup', function(e) {
        ...
        rows.forEach(function(row) {
            try {
                ...
                const registradoPor = cells[2].textContent.toLowerCase();
                const paisOrigen = cells[3].textContent.toLowerCase();
...
window.addEventListener('error', function(e) {
    if (e.filename && e.filename.includes('marcas.js')) {
        console.error('Error en marcas.js:', e.message, e.lineno, e.colno);
    }
});

console.log('Archivo marcas.js completamente cargado');